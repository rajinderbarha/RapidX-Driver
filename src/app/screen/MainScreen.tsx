...
export default function MainScreen(){
    ...
    const { rideConfirmed } = useContext(RideContext);
  ...
  return (
    ...
    <View style={styles.mapContainer}>
      <Map
        ...
        reff={mapRef}
      />
    {rideConfirmed &&   <OrangeButton onPress={()=>{navigation.navigate('Current Ride Details')}} text="Current Ride Details" style={{
          position: "absolute",
      ...
      <OnFinishedRideModal onChange={handleModalChange} isFocused={isFocused}/>
      {/* <RatingModal isVisible={true} requestDetails={{name : 'vv'}}/> */}
    </View>
    <MyLocationButton
